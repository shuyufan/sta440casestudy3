...
set.seed(15)  ## seed(15) --> 7.3% win probability
...
blue_EVs_2012 = sum(elec_votes_df$EV*elec_votes_df$blue2012) + 3 # DC
safe_blue_2016 = blue_EVs_2012  ## Will subtract states in model
...
for (st in states) {
  ...
  if (elec_votes_df[elec_votes_df$Abbrev==st,"blue2012"] == 1) {
    safe_blue_2016 = safe_blue_2016 - st_EVs
  }
}
...
ec_votes_dem = ec_votes_inc_states+safe_blue_2016 #anything else Biden should win (CT, Hawaii, IL, RI, DC)
