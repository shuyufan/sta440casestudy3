...
## Point Estimates for Dem Vote Share by District

```{r}
elec_sims %>% apply(2, mean)
```

## Interval Estimates for Dem Vote Share by District

```{r}
elec_sims %>% apply(2, quantile, probs=c(0.025, 0.975))
```
