...
*where explain variables later the S&P stock growth three months prior to the election and also explain i where i is each year in that Abramowitz data*.
