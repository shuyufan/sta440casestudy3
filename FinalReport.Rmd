...
```{r pres-plot, echo = F, fig.height = 8, fig.width = 4, fig.cap = "\\label{trumpwintime} Probability of Re-election for President Trump over the 30 Days Before Election Day"}
...
```{r echo = F, fig.height = 8, fig.width = 4, fig.cap = "\\label{trumpusmap} Plot of Predicted Presidential Result for States of Interest on Election Day}
...
```{r echo = F, fig.height = 8, fig.width = 4, fig.cap = "\\label{senateusmap} Plot of Predicted Senate Results for States of Interest on Election Day}
...
```{r echo = F, fig.height = 8, fig.width = 4, fig.cap = "\\label{senatehist} Plot of Predicted Senate Results for States of Interest on Election Day}
...
```{r, echo = F, fig.height = 8, fig.width = 4, fig.cap = "\\label{housemap} Plot of Predicted Senate Results for States of Interest on Election Day}
...
pres_res = as.data.frame(jags_sims_mv$BUGSoutput$summary[,-c(8,9)])
...
pres_res = as.data.frame(jags_sims$BUGSoutput$summary[,-c(8,9)])
...
pres_res = as.data.frame(jags_sims_house$BUGSoutput$summary[,-c(8,9)])
...
\newline
?? Silver, N. (2014) Registered Voter Polls Will (Usually) Overrate Democrats.
Retrieved October 31, 2020 from https://fivethirtyeight.com/features/registered-voter-polls-will-usually-overrate-democrats/
\newline
?? The Economist. (2020). Forecasting the US elections. https://projects.economist.com/us-2020-forecast/president/how-this-works

?? The Economist. (2016). Hillary Clinton has got this. Probably. Very probably https://www.economist.com/graphic-detail/2016/11/08/hillary-clinton-has-got-this-probably-very-probably
