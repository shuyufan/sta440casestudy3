...
national_mu_prior <- predict(prior_model,newdata = tibble(q2gdp = -31.4, juneapp = -10))

national_mu_prior <- 100 - predict(prior_model,newdata = tibble(q2gdp = 1.1, juneapp = 4))
...
priors = 0.4*national_mu_prior + 0.6*lean_to_prior(leans_states)
