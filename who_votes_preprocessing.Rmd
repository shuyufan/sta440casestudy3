...
```{r}
summary(voter_hist_districts_resp$birth_age)
...
# sample interpretation plot

```{r}
# plot(binary_model, effects = "age_binned:party_cd", ncol = NULL, points = FALSE,
...
# library(visreg)
# 
# visreg(binary_model, xvar = "")
# visreg(binary_model, "party_cd", by="gender_code", scale="response", overlay=TRUE, rug=FALSE,ylab="Probability", gg=TRUE)
```
...
```{r}
rand_effects_model = readRDS("randeff_sa_grouped_model_output.rds")
```
