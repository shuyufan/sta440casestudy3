...
model_output <- jags(data = data_build_model,
                     ...
                     model.file = model1)
model_output
saveRDS(model_output, "model_output_preds_n1000_iter1000")
```
