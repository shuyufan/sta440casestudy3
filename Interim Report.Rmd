...
Most of the standardized residuals are within +/- 2, but some points have somewhat larger values. This means that for the majority of the groupings, the model predicts fairly well. 
