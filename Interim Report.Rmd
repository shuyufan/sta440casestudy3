...
- For a white, female Democrat aged 18-29 whose median household income is in the second quartile ($\$46.9k-\$52.8k$), the odds of voting increases by a multiplicative factor `r round(exp(0.1),2)` with a 95% CI of (`r round(exp(0.09),2)`, `r round(exp(0.10),2)`). 
