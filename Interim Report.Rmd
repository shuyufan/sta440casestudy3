...
```{r EDA, echo=F, fig.width=6,fig.height=2.8, fig.align='center', fig.cap="Grouped Feature Variable Exploration"}
...
=======
The baseline is `Median Income < $46864` for income, `Female` for gender, `White` for race, `18-30` for age, and `Democrat` for party affiliation. 
>>>>>>> 9b7fb24e0b6db5ad885a81ca6185016e1e50299c
...
```{r plot-to-interpret-interactions1, echo = F, message = F, warning = F, fig.width = 8, fig.height = 4, fig.cap="Marginal Effect of Race by Party and Gender"}
...
```{r plot-to-interpret-interactions2, echo = F, message = F, warning = F, fig.width = 8, fig.height=4, fig.cap = "Marginal Effect of Party by Age and Race"}
...
```{r external-validation, include = F, message = F, warning = F}
...
```{r traceplots, echo = F, warning = F, message = F}
# Traceplots
