...
$$
\begin{aligned}
logit(Vote_i) = \beta_0 + \Sigma_{j \in S}\beta_{j}*I(Income_i = Income \ Categoty_j) + \Sigma_{j \in G}\beta_{j}*I(Gender_i = Gender \ Category_j) +\\
\Sigma_{j \in R}\beta_{j}*I(Race_i = Race \ Category_j) + \Sigma_{j \in A}\beta_{j}*I(Age_i = Age \ Category_j) +\\
\Sigma_{j \in P}\beta_{j}*I(Party_i = Party_Category_j) + \Sigma_{j \in G, k \in P}beta_{jk}I(Gender_i = Gender \ Category_j)I()
\end{aligned}
$$
