...
```{r, echo = F, fig.width = 8, fig.height = 4, fig.cap = "Coverage Plot for Random Effects Model"}
voter_grouped = voter_hist_districts_resp %>%
  group_by(age_binned, gender_code, party_cd, race_code, med_inc_binned, cong_dist_abbrv) %>%
  summarise(n = n(), votes = sum(vote_or_not))
...
```{r resids-randeff, echo = F, fig.width = 8, fig.height = 4, fig.cap = "Random Effects Model Residual Plot"}
# Residuals
